...
import {AlpinistEditPage} from "./AlpinistEditPage/AlpinistEditPage.tsx";
            ...
            <Router>
                ...
                <Routes>
                    <Route path="/" element={<MainLayout/>}>
                        ...
                        <Route path="/rip_front/alpinist/:id/edit" element={<AlpinistEditPage/>}/>
                        <Route path="/rip_front/alpinist/create" element={<AlpinistEditPage/>}/>
                        <Route path="/rip_front/alpinists/editable" element={<AlpPageForModer/>}/>
                    </Route>
                </Routes>
            </Router>
        </Provider>
